...
//!
//! This module provides the `TableEngineRegistry` which manages the lifecycle
//! of table engine instances, providing factory methods for creating different
//! engine types (BTree, LSM, Memory, Blob) and managing their lifecycle.

use crate::pager::{PageId, Pager};
use crate::table::{
    LsmConfig, MemoryBlob, MemoryBTree, PagedBTree, TableEngineKind, TableOptions,
};
