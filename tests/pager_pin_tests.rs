...
use nanokv::pager::{Page, PageType, Pager, PagerConfig, PagerError};
...
fn test_cannot_free_pinned_page() {
    ...
    for i in 0..page_count {
        ...
        page.data_mut().extend_from_slice(format!("Page {} data", i).as_bytes());
    ...
    assert!(pinned_encountered, "Should have encountered pinned pages during concurrent read/free operations");
}
